...
**Última actualización**: 2026-06-27 por sesión Fase 3 (Claude)
**Rama activa**: `feat/fase-3-maestros` (desde `develop`)
...
4. **Fase 4** (Stock + movimientos + PPP + correlativos): reusar `src/lib/ppp.ts`, `counters`, y la infra de tablas/forms de Fase 3 (`DataTable`, `DataTableToolbar`, patrón de form modal). Al construir Stock, agregar las columnas de stock/valor diferidas en las tablas de maestros (Productos/Bodegas).
